...
public class ProdutoController {
	...
	@GetMapping("/preco/{start}/preco/{end}")
		public ResponseEntity<List<Produto>> getByPrecoBetween(@Valid @PathVariable BigDecimal start, @Valid @PathVariable BigDecimal end) {
			return ResponseEntity.ok(produtoRepository.findAllByPrecoBetween(start, end));
	}
	@PostMapping
